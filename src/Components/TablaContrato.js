...
const TablaContrato = ({ contratos = [], eliminarContrato = () => {}, editarContrato = () => {}, verClientes = () => {}, currentUser = null, useScrollView = false }) => {
  return (
    <View style={styles.container}>
      ...
      {contratos.length === 0 ? (
        ...
        // When useScrollView is true we render a simple mapped list (non-virtualized)
        useScrollView ? (
          <View>
            {contratos.map(c => {
